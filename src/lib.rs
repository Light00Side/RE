...
#[derive(Debug)]
pub struct RESTfulNexusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RESTfulNexusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RESTfulNexus processing");
    
    let mut processor = RESTfulNexusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RESTfulNexusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RESTfulNexusProcessor::new(false);
